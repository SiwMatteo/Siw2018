...
<body>
	...
	<div id="welcome" class="container">
		<div><font color="yellow">${allievoNonTrovato}</font></div>
		<c:if test="${allievoTrovato!=null}">
		<table align="center">
			<tr>
		 		<td>Nome</td><td>Cognome</td><td>Telefono</td>
		 	</tr>
			<tr>
		    	<td>${allievoTrovato.nome}</td>
				<td>${allievoTrovato.cognome}</td>
				<td>${allievoTrovato.telefono}</td>
			</tr>
		</table>
		</c:if>
				<br> 
